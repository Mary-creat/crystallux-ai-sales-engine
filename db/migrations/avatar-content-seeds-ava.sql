...
--
-- IDs are deterministic UUIDs prefixed `a0a0-…` so re-running the
...
SELECT * FROM (VALUES
  -- ─── Life insurance (5) ───
  ('00000000-a0a0-0000-0001-000000000001'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 85),
  ('00000000-a0a0-0000-0001-000000000002'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    'How much life insurance do you actually need?',
    'The 10x-income rule + DIME method explained. Walk through a needs analysis live.',
    'admin', 'approved', 90),
  ('00000000-a0a0-0000-0001-000000000003'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 75),
  ('00000000-a0a0-0000-0001-000000000004'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 70),
  ('00000000-a0a0-0000-0001-000000000005'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
  ...
  -- ─── Auto insurance (3) ───
  ('00000000-a0a0-0000-0002-000000000001'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 80),
  ('00000000-a0a0-0000-0002-000000000002'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    'Optional auto coverages: which are worth it, which aren''t',
    'OPCF 20, OPCF 27, OPCF 44R — practical guidance per driver type.',
    'admin', 'approved', 65),
  ('00000000-a0a0-0000-0002-000000000003'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
  ...
  -- ─── Home insurance (3) ───
  ('00000000-a0a0-0000-0003-000000000001'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 80),
  ('00000000-a0a0-0000-0003-000000000002'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 75),
  ('00000000-a0a0-0000-0003-000000000003'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
  ...
  -- ─── Travel insurance (2) ───
  ('00000000-a0a0-0000-0004-000000000001'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 70),
  ('00000000-a0a0-0000-0004-000000000002'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
  ...
  -- ─── Critical illness (3) ───
  ('00000000-a0a0-0000-0005-000000000001'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 80),
  ('00000000-a0a0-0000-0005-000000000002'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    'Return-of-premium critical illness: what you actually get back',
    'The 15-year break-even math, with a real policy example.',
    'admin', 'approved', 65),
  ('00000000-a0a0-0000-0005-000000000003'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
  ...
  -- ─── Disability (2) ───
  ('00000000-a0a0-0000-0006-000000000001'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 85),
  ('00000000-a0a0-0000-0006-000000000002'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
  ...
  ('00000000-a0a0-0000-0007-000000000001'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 75),
  ('00000000-a0a0-0000-0007-000000000002'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 80),
  ('00000000-a0a0-0000-0007-000000000003'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
  ...
  ('00000000-a0a0-0000-0008-000000000001'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 70),
  ('00000000-a0a0-0000-0008-000000000002'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
    ...
    'admin', 'approved', 65),
  ('00000000-a0a0-0000-0008-000000000003'::uuid, 'insurance', (SELECT id FROM avatars WHERE avatar_name='AVA'),
...
WHERE ct.id::text LIKE '00000000-a0a0-%'
